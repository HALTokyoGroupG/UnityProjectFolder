...
*/
public class PropsTest : MonoBehaviour {
...
//			GameObject work = Instantiate(characterPrefab, pos, Quaternion.identity) as GameObject;
//			Character3D character3D = work.GetComponent< Character3D >( );
//			character3D.Data = CharacterDatabase.Get ( SD.nId );
//		}
		GameObject work = Instantiate(characterPrefab, Vector3.zero, Quaternion.identity) as GameObject;
		work.transform.parent = this.transform;
		Character3D character3D = work.GetComponent< Character3D >( );
		character3D.Data = CharacterDatabase.Get( "もぶ" );
	}
